...
PEHeaders::PEHeaders(BinaryViewRef data)
{
	...
	AddField("Stack Size", QString("0x") + QString::number(stackCommit, 16) + QString(" / 0x") + QString::number(stackReserve, 16));
	...
	AddField("Heap Size", QString("0x") + QString::number(heapCommit, 16) + QString(" / 0x") + QString::number(heapReserve, 16));
	...
	AddField("Linker Version", QString::number(linkerMajor) + QString(".") + QString::number(linkerMinor).rightJustified(2, '0'));
	...
	AddField("Image Version", QString::number(imageMajor) + QString(".") + QString::number(imageMinor).rightJustified(2, '0'));
	...
	AddField("Subsystem Version", QString::number(subMajor) + QString(".") + QString::number(subMinor).rightJustified(2, '0'));
...
HeaderWidget::HeaderWidget(QWidget* parent, const Headers& header) :
    QWidget(parent)
{
